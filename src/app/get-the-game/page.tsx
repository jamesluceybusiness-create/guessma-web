  ...
  return (
    <main style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <p style={{ color: 'var(--muted)', fontSize: '1.05rem', marginBottom: '3rem', maxWidth: '420px', lineHeight: 1.6 }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '3.5rem', fontWeight: 800, color: 'var(--text)', lineHeight: 1 }}>$5</div>
            <div style={{ fontSize: '0.85rem', color: 'var(--muted)', marginTop: '0.25rem' }}>one-time · no subscription</div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', textAlign: 'left' }}>
            {[
              ...
              <div key={feature} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                <span style={{ color: 'var(--green)', fontSize: '1rem', fontWeight: 700, flexShrink: 0, marginTop: '0.1rem' }}>✓</span>
          ...
          <p style={{ color: 'var(--muted)', fontSize: '0.8rem', margin: 0, textAlign: 'center', lineHeight: 1.5 }}>
