...
export default function AdminVerifyPage() {
  ...
  useEffect(() => {
    async function init() {
      ...
      if (!verified) { router.replace('/account/setup-mfa'); return }
    ...
    <div style={PAGE}>
      <div style={CARD}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <p style={{ fontSize: '0.82rem', color: '#9ab89a', lineHeight: 1.5 }}>
        ...
        <form onSubmit={handleVerify} style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          ...
          {error && (
            <p style={{ color: '#ef4444', fontSize: '0.78rem', textAlign: 'center', margin: 0 }}>{error}</p>
          )}
