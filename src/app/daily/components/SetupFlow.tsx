...
const BTN_OUTLINE: React.CSSProperties = {
  width: '100%', height: 'clamp(2.8rem, 6vh, 3.5rem)', padding: '0 1.5rem',
  background: 'transparent', color: '#94a3b8', border: '1px solid #1a4a5a',
    ...
    return (
      <Wrap>
        <div style={CARD}>
          ...
          {authLoading ? (
            <div style={{ color: '#94a3b8', fontSize: '0.9rem', textAlign: 'center', padding: '2rem 0' }}>Checking account…</div>
          ) : gs.hostAccount ? (
            <>
              <p style={{ color: '#94a3b8', fontSize: 'clamp(0.85rem, 1.8vh, 1rem)', margin: 0 }}>Playing as:</p>
              <div style={{
                background: '#0d2d3d', border: '1px solid #1a4a5a', borderRadius: '0.75rem',
                padding: '0.6rem 0.75rem', display: 'flex', alignItems: 'center', gap: '0.75rem',
              }}>
                <div style={{
                  width: '40px', height: '40px', borderRadius: '50%', background: '#29afd4',
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ color: '#64748b', fontSize: '0.7rem' }}>@{gs.hostAccount.username ?? ''}</div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ color: '#29afd4', fontWeight: 900, fontSize: '0.8rem' }}>
                    {gs.hostAccount.karma_lifetime ?? 0} <span style={{ color: '#64748b', fontWeight: 400, fontSize: '0.62rem' }}>KARMA</span>
                  </div>
                  <div style={{ color: '#f97316', fontWeight: 700, fontSize: '0.75rem' }}>
                    🔥 {playerStats?.current_streak ?? 0} <span style={{ color: '#64748b', fontWeight: 400, fontSize: '0.62rem' }}>STREAK</span>
                  </div>
                </div>
              </div>
            ...
            <>
              <div style={{
                ...
                <div>
                  <div style={{ fontWeight: 700, color: '#facc15', fontSize: '0.9rem', marginBottom: '0.25rem' }}>Playing as guest</div>
                  <div style={{ color: '#94a3b8', fontSize: 'clamp(0.8rem, 1.6vh, 0.9rem)', lineHeight: 1.5 }}>
        ...
        <div style={CARD}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', flex: 1, minHeight: 0, overflowY: 'auto' }}>
            <button
              ...
              style={{
                background: partnerMode === 'guest' ? 'rgba(22,163,74,0.15)' : '#091e2a',
                border: partnerMode === 'guest' ? '2px solid #16a34a' : '1px solid #1a4a5a',
            ...
            >
              ...
              <div>
                ...
                <div style={{ color: '#94a3b8', fontSize: 'clamp(0.8rem, 1.6vh, 0.9rem)', lineHeight: 1.4 }}>
            ...
            {partnerMode === 'guest' && (
              <input
                ...
                style={{
                  width: '100%', padding: '0.55rem 0.75rem', background: '#091e2a',
                  border: '1px solid #1a4a5a', borderRadius: '8px', color: '#c8d8c8',
                  fontFamily: 'Poppins, sans-serif', fontSize: 'clamp(0.85rem, 1.8vh, 1rem)', outline: 'none',
            ...
            {gs.hostUser && (
              <button
                ...
                style={{
                  background: partnerMode === 'linked' ? 'rgba(22,163,74,0.15)' : '#091e2a',
                  border: partnerMode === 'linked' ? '2px solid #16a34a' : '1px solid #1a4a5a',
                  borderRadius: '12px', padding: '1rem', textAlign: 'left',
                  cursor: 'pointer', display: 'flex', gap: '0.75rem', alignItems: 'flex-start',
                  fontFamily: 'Poppins, sans-serif',
                }}
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ color: '#94a3b8', fontSize: 'clamp(0.8rem, 1.6vh, 0.9rem)', lineHeight: 1.4, marginBottom: partnerMode === 'linked' ? '0.75rem' : 0 }}>
                  ...
                  {partnerMode === 'linked' && (
                    <div onClick={e => e.stopPropagation()}>
                      {selectedPartner ? (
                        <div style={{
                          background: '#0d2d3d', border: '1px solid #1a4a5a', borderRadius: '8px',
                          padding: '0.5rem 0.65rem', display: 'flex', alignItems: 'center', gap: '0.5rem',
                        }}>
                          <div style={{
                            width: '28px', height: '28px', borderRadius: '50%', background: '#29afd4',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ color: '#64748b', fontSize: '0.65rem' }}>@{selectedPartner.username ?? ''}</div>
                          </div>
                          <button
                        ...
                        <>
                          <input
                            ...
                            style={{
                              width: '100%', padding: '0.45rem 0.65rem', background: '#091e2a',
                              border: '1px solid #1a4a5a', borderRadius: '8px', color: '#c8d8c8',
                              fontFamily: 'Poppins, sans-serif', fontSize: 'clamp(0.85rem, 1.8vh, 1rem)', outline: 'none',
                              boxSizing: 'border-box',
                            }}
                          ...
                          {searchResults.length > 0 && (
                            <div style={{ marginTop: '0.35rem', background: '#091e2a', border: '1px solid #1a4a5a', borderRadius: '8px', overflow: 'hidden' }}>
                              {searchResults.map(acc => (
                                <button
                                  ...
                                  style={{
                                    ...
                                    background: 'none', border: 'none', borderBottom: '1px solid #1a4a5a',
    ...
    return (
      <Wrap>
        <div style={CARD}>
          ...
          <p style={{ color: '#94a3b8', fontSize: 'clamp(0.85rem, 1.8vh, 1rem)', margin: 0 }}>
            Who is hinting and who is guessing for the core round?
          </p>

          <div style={{ display: 'flex', gap: '0.75rem' }}>
            <div style={{ flex: 1, background: '#091e2a', border: '1px solid #1a4a5a', borderRadius: '12px', padding: '1rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <select
                ...
                style={{
                  background: '#0d2d3d', border: '1px solid #1a4a5a', borderRadius: '6px',
                  color: 'white', padding: '0.35rem 0.5rem', fontFamily: 'Poppins, sans-serif',
            ...
            <div style={{ flex: 1, background: '#091e2a', border: '1px solid #1a4a5a', borderRadius: '12px', padding: '1rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <div style={{
                background: '#0d2d3d', border: '1px solid #1a4a5a', borderRadius: '6px',
                color: '#94a3b8', padding: '0.35rem 0.5rem', fontSize: '0.8rem',
              }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
            ...
            {randomized && (
              <p style={{ color: '#16a34a', fontSize: '0.78rem', textAlign: 'center', margin: 0 }}>
    ...
    return (
      <Wrap>
        <div style={CARD}>
          ...
          <p style={{ color: '#94a3b8', fontSize: 'clamp(0.85rem, 1.8vh, 1rem)', margin: 0, lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            <div style={{
              ...
              <div style={{ fontSize: '0.65rem', color: '#facc15', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700, marginBottom: '0.3rem' }}>
                Hinting
              </div>
              <div style={{ fontWeight: 800, color: '#facc15', fontSize: '1rem' }}>{hinterName}</div>
              <div style={{ color: '#78350f', fontSize: '0.72rem', marginTop: '0.2rem' }}>facing screen</div>
            </div>
            <div style={{
              flex: 1, background: 'rgba(63,63,70,0.3)', border: '1px solid #1a4a5a',
              borderRadius: '12px', padding: '1rem', textAlign: 'center',
            }}>
              <div style={{ fontSize: '0.65rem', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700, marginBottom: '0.3rem' }}>
                Guessing
              </div>
              <div style={{ fontWeight: 800, color: 'white', fontSize: '1rem' }}>{guesserName}</div>
              <div style={{ color: '#64748b', fontSize: '0.72rem', marginTop: '0.2rem' }}>back to screen</div>
            </div>
          </div>
